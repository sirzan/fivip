...
public function traerImpresionFactura(){
    ...
    $data1 = $respuesta->apiReporteRango($fechaInicial,$fechaFinal);
    $data2 =$respuesta->apiReportemontoTotalesRando($fechaInicial,$fechaFinal);
    $data3 =$respuesta->apiReporteremesaTotalesRango($fechaInicial,$fechaFinal);
    $comision =$respuesta->apiReporteremesaComisionRango($fechaInicial,$fechaFinal);
