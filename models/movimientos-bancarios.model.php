...
class ModeloMovimientosBancarios{
    static public function mdlIngresarMovimiento($tabla, $datos,$info){
            try {
                ...
                $stmt = Conexion::conectar($info)->prepare("INSERT INTO $tabla(cuenta_banco_vene_id, c_transfer_vene_id, cuenta_banco_inter_id, monto, pago_remesa_id,operacion,signo,recargas_id,monto_actual,boleto_id,created_at) VALUES(:cuenta_banco_vene_id, :c_transfer_vene_id, :cuenta_banco_inter_id, :monto, :pago_remesa_id,:operacion,:signo,:recargas_id,:monto_actual,:boleto_id,:created_at)");
                ...
                $stmt->bindParam(":monto_actual", $datos["monto_actual"], PDO::PARAM_STR);
