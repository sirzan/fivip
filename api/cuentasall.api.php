...
// Obtener registros
try {
    $stmt = Conexion::conectar($_POST['info'])->prepare("SELECT cuenta_banco_vene.id AS id_cuenta,saldo_cuenta_vene.id AS id_saldo,saldo,n_titular,a_titular,banco_id,nombre,moneda_id,moneda,simbolo,iso FROM saldo_cuenta_vene  
