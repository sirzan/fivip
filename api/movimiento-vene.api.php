...
// Obtener registros
$stmt = Conexion::conectar()->prepare("SELECT T1.id,T1.cuenta_banco_vene_id,T2.nombre,T2.n_titular,T2.a_titular,T3.simbolo,T1.monto,T3.iso,T1.monto_actual,T1.operacion,signo,T1.created_at FROM 
